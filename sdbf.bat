...
echo.
 ...
 :: create folders if do not exist
    if not exist %dailydump%\NUL mkdir %currDir%0_Daily
    if not exist %weeklydump%\NUL mkdir %currDir%1_Weekly
    if not exist %monthlydump%\NUL mkdir %currDir%2_Monthly
    if not exist %biannualdump%\NUL mkdir %currDir%3_Bi-Annually
